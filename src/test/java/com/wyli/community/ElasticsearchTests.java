...
import com.wyli.community.dao.elasticsearch.DiscussPostRepository;
...
public class ElasticsearchTests {
    ...
    public void testInsert() {
        ...
        repository.save(mapper.selectDiscussPostById(282));
        repository.save(mapper.selectDiscussPostById(283));
    }

    @Test
    public void testInsertList() {
        repository.saveAll(mapper.selectDiscussPosts(0, 0, 300));
    }

    @Test
    public void testUpdate() {
        DiscussPost post = mapper.selectDiscussPostById(280);
        post.setTitle("世界之窗");
    ...
    public void testSearchByTemplate() {
        SearchQuery searchQuery = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.multiMatchQuery("就业", "title", "content"))
                .withSort(SortBuilders.fieldSort("type").order(SortOrder.DESC))
                .withSort(SortBuilders.fieldSort("score").order(SortOrder.DESC))
                .withSort(SortBuilders.fieldSort("createTime").order(SortOrder.DESC))
                .withPageable(PageRequest.of(0, 10))
        ...
        Page<DiscussPost> page = elasticTemplate.queryForPage(searchQuery, DiscussPost.class, new SearchResultMapper() {
            ...
            public <T> AggregatedPage<T> mapResults(SearchResponse searchResponse, Class<T> aClass, Pageable pageable) {
                ...
                for (SearchHit hit : hits) {
                    ...
                    discussPost.setId(Integer.valueOf(userId));
